...
export default class UserController {
    ...
    public emailVerification = async (req: any, res: any) => {
        //     try {
        //         const token = utils.decodeAuthToken(req.params.token);
        //         let message = "";
    ...
    public updateProductDetail = async (req: any, res: Response): Promise<Response> => {
        try {
                        const productList = await Axios.put(`${process.env.PRODUCT_URL}/api/v1/product/updateProduct/${req.params.productId}`, {
    ...
    public deleteProductDetail = async (req: any, res: Response): Promise<Response> => {
        try {
            const productList = await Axios.delete(`${process.env.PRODUCT_URL}/api/v1/product/deleteProduct/${req.params.productId}`,)
            return res.status(responseConstants.STANDARD.SUCCESS).send({
